...
* ConcertsCardDeck - the area in which all the concerts cards are displayed. Each concert card has an image, a title, a description and a footer with sort by year and sort by rating buttons.
